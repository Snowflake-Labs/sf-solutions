...
(1, 'オーガニック牛乳 1L', '飲料', '乳製品', 298, 180, 'サプライヤーA', 2),
(2, 'プレミアムコーヒー豆 200g', '飲料', 'コーヒー', 980, 550, 'サプライヤーB', 7),
(3, '国産鶏もも肉 300g', '精肉', '鶏肉', 498, 320, 'サプライヤーC', 1),
(4, '有機バナナ 1房', '青果', 'フルーツ', 198, 100, 'サプライヤーD', 3),
(5, '全粒粉食パン 6枚切', 'パン', '食パン', 248, 140, 'サプライヤーE', 1),
(6, '特選醤油 500ml', '調味料', '醤油', 398, 220, 'サプライヤーF', 5),
(7, '冷凍餃子 12個入', '冷凍食品', '中華', 358, 200, 'サプライヤーG', 3),
(8, 'ヨーグルト 400g', '飲料', '乳製品', 178, 95, 'サプライヤーA', 2),
(9, 'カップ麺 しょうゆ味', '即席麺', 'カップ麺', 198, 110, 'サプライヤーH', 4),
(10, 'ミネラルウォーター 2L', '飲料', '水', 98, 40, 'サプライヤーI', 2),
(11, 'ポテトチップス うすしお', 'スナック', 'ポテト系', 158, 85, 'サプライヤーJ', 3),
(12, '豆腐 絹ごし 300g', '日配品', '豆腐', 88, 45, 'サプライヤーK', 1),
(13, 'トマト缶 400g', '缶詰', '野菜缶', 128, 65, 'サプライヤーL', 10),
(14, 'バター 200g', '飲料', '乳製品', 448, 300, 'サプライヤーA', 3),
(15, '卵 10個入パック', '日配品', '卵', 268, 180, 'サプライヤーM', 1);
